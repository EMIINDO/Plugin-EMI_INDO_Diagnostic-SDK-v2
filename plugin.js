...
// Porting BY EMI INDO with c3addon-ide-plus
{
    ...
    const PLUGIN_ID = "EMI_INDO_Diagnostic";
    // callMap Deprecated const PLUGIN_VERSION = "1.0.0.3";
    const PLUGIN_CATEGORY = "platform-specific";

    const PLUGIN_CLASS = SDK.Plugins.EMI_INDO_Diagnostic = class DiagnosticPlugin extends SDK.IPluginBase {
        constructor() {
            super(PLUGIN_ID);
